...
function FormField (props) {
  const fields = {
    name: (
      <div>
        <label>Name:</label><br />
        <input className='definition-field' id='name' /><br />
      </div>
    ),
    type: (
      <div>
        <label>Type:</label><br />
        <input className='definition-field' id='type_' /><br />
      </div>
    ),
    data: (
      <div>
        <label>Data:</label><br />
        <textarea className='definition-field' id='data' /><br />
      </div>
    ),
    components: (
      <div>
        <label>Components:</label><br />
        <textarea className='definition-field' id='components' /><br />
      </div>
    )
  }
